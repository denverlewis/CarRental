...
public class Controller extends JFrame {
    ...
    public Controller() {
        ...
        JLabel header = new JLabel(new ImageIcon(getClass().getResource("logo.png")));
        Menu menu = new Menu();
    ...
    public static void setValues() {
        ...
        TestGUI test = new TestGUI(RentalForm.getFName(), RentalForm.getSName());
        ...
        OutputScreen.outputMessage("Has Selected Car Category " + RentalForm.getCarCat());
